...
<head>
  ...
  <link rel="stylesheet" href="${ctx}/static/AdminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<script src="${ctx}/static/AdminLTE/plugins/morris/morris.min.js"></script>
<!-- Sparkline -->
<script src="${ctx}/static/AdminLTE/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="${ctx}/static/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="${ctx}/static/AdminLTE/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="${ctx}/static/AdminLTE/plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
